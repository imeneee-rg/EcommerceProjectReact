                            ...
                            <div class="col-md-8 clearfix">
                                <div class="shop-menu clearfix pull-right">
                                    <ul class="nav navbar-nav">
                                        ...
                                        <li><a href="/cart"><i class="fa fa-shopping-cart"></i> Cart ({cart.length}) </a></li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3">
                               {/* <div class="search_box pull-right">
                                    <input type="text" onChange={(e) => dispatch(filtername({ text  : e.target.value}))}  placeholder="Search" />
    </div>*/}
                            </div>
                        </div>
                    </div>
