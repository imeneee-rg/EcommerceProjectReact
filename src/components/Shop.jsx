...
import { filterprice, filtrecategory, selectproducts } from '../features/products/productsSlice'
                ...
                <div className="col-sm-3">
                    <div className="left-sidebar">
                        ...
                        <div class="search_box w-100">
                            <input type="text" onChange={(e) => dispatch(filterprice({ price: e.target.value }))} placeholder="max pice" />
                        </div>
