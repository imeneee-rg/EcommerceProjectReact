...
import { createproduct, filtrecategory, getproducts, selectaddstatus, selectproducts } from '../../features/products/productsSlice';
    ...
    return (
         <div className='container'>
            ...
            <div style={{ display: "flex", justifyContent: 'space-between' }}>
              ...
              {/*  <div style={{ marginLeft: "10px", display: 'flex', justifyContent: "space-between", padding: '10px', background: 'lightgray', borderRadius: '7px' }}  >
