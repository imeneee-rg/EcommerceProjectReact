...

        {
            ...
            render: (text, record) => (
                <>
                    {record.livred === 1 &&
                        <>
                            <CheckCircleOutlined onClick={() => upadte(record, 2)} style={{ fontSize: "20px", color: "green", cursor: "pointer" }} />
                            <CloseCircleOutlined onClick={() => upadte(record, 3)} style={{ fontSize: "20px", color: "red", marginLeft: "10px", cursor: "pointer" }} />
                        </>
                    }
